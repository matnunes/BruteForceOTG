...
public:
    ...
    void setupUi(QDialog *SettingsDialog)
    {
        ...
        lineEdit_2 = new QLineEdit(parametersBox);
        ...
        lineEdit = new QLineEdit(parametersBox);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));

        gridLayout_2->addWidget(lineEdit, 5, 1, 1, 1);
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        label_2->setText(QApplication::translate("SettingsDialog", "Screen off value:", nullptr));
        baudRateLabel->setText(QApplication::translate("SettingsDialog", "BaudRate:", nullptr));
        label->setText(QApplication::translate("SettingsDialog", "Timeout on error (s):", nullptr));
